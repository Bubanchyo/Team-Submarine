...
<script
    ...
    <nav class="navbar navbar-default" id="mainNav">
      <div class="container-fluid">
        <a class="navbar-brand" href="#page-top">wanderlust</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 mx-auto">
					...
					<!-- filterable List (hashtag 검색해서 포스팅 찾기) -->
					<form>
	...
	<section id="projects" class="projects-section bg-light">
		<div class="container">
			...
			<div class="row align-items-center no-gutters mb-4 mb-lg-5">
				<div class="col-xl-8 col-lg-7">
					<img class="img-fluid mb-3 mb-lg-0"
						src="./resources/img/bg-masthead.jpg" alt="">
				</div>
			...
			<div class="row justify-content-center no-gutters mb-5 mb-lg-0">
				<div class="col-lg-6">
					<img class="img-fluid" src="./resources/img/demo-image-01.jpg"
						alt="">
				</div>
				<div class="col-lg-6">
			...
			<div class="row justify-content-center no-gutters">
				<div class="col-lg-6">
					<img class="img-fluid" src="./resources/img/demo-image-02.jpg"
						alt="">
				</div>
