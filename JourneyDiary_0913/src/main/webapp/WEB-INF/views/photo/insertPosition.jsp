...
<script>
	...
	function imageAnalysis(photono){
		console.log(photono);
		 $.ajax({
         	url:"imageAnalysis",
...
<h1>위치정보 추가</h1>
	...
	<br>
	<textarea name="photocontent" rows="10" cols="90" style="resize: none" disabled="disabled">${photoDetail.photocontent}</textarea>
	<div id="hashtag"><a href="#">${photoDetail.keyword}</a></div>
	<input type="date" name="dateoftravel" value="${photoDetail.dateoftravel}" disabled="disabled"> <br>
	
	<input type="button" value="이미지 인식" onclick="imageAnalysis('${photoDetail.photono}')"><br>
