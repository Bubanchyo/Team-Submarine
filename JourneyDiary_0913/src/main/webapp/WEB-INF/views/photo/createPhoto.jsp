			...
			<div class="content-section-heading text-center">
				...
				<div class="avatar-upload">
					<div class="avatar-edit">
						...
						<label for="imageUpload" style="background-image: url(./resources/img/pencil.png); background-size: 30px 30px; background-repeat: no-repeat; background-position: center;"></label>
					</div>
				...
				<div class="form-group">
					<div class="wrapper">
						<h4>Album Title</h4>
  						<textarea name="the-textarea" id="albumtitle" name="albumtitle" maxlength="50" placeholder="Start Typin…" autofocus></textarea>
  							<div id="the_count">
				...
				<div class="form-group">
					<div class="wrapper">
						<h4>Album Introduction</h4>
  						<textarea name="the-textarea" id="the_textarea" name="albumintro" maxlength="300" placeholder="Start Typin…" autofocus></textarea>
  							<div id="the_count">
    							<span id="current">0</span>
